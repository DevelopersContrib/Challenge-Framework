...
include('header-new-v2.php');
	...
	<script>window.location="http://earthchallenge.com/home.php";</script>	
	<? 
	}
$earthchaId="120";
?>
...
<div class="jcenter">
	...
	<div class="form-box rightbar">
			...
			<p class="text">If you join as a challenger, you will be able to take part in joining a live challenge, 
